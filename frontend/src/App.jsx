...
<Route path="/chat/:psychicId" element={<ProtectedRoute><InterFace /></ProtectedRoute>} />
        ...
        <Route path="/monthly-forecast" element={<ProtectedRoute><MonthlyForecast /></ProtectedRoute>} />
        <Route path="/love-compatibility" element={<ProtectedRoute><LoveCompatibility /></ProtectedRoute>} />
        ...
        <Route path="/astrology-report" element={<ProtectedRoute><AstrologyReport /></ProtectedRoute>} />
